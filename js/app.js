...
function ocultarRegistros(nombre_buscar) {
  // variable para odos los registros
  var registros = tableBody[0].getElementsByTagName('tr');
  // expresion regula que busca el nombre con case insensitive
...
function recorrerBotonesGuardar(id) {
  console.log("recorrerBotonesGuardar");
  console.log(id);
